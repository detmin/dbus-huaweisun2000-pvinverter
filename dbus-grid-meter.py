...
class DbusGridMeterService:
    ...
    def _update(self):
        try:
            # Read all DBus values OUTSIDE the lock to prevent blocking
            ...
            # Read all values from PV service OUTSIDE the lock
            meter_values = {}
            valid_count = 0
            ...
            # Now update DBus INSIDE the lock with all collected data
            with self._dbusservice as s:
                for grid_path, value in meter_values.items():
